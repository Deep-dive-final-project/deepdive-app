...
export default function HomePage() {
  return (
    <div>
      ...
      <p>
        use client를 <span className={style.use}>쓰는 컴포넌트</span>와{" "}
        <span className={style.notUse}>안쓰는 컴포넌트</span>를 같은 페이지에
        배치할 수 있어요
      </p>
      <hr />
      <p>
      ...
      <div className={style.useComponent}>
        <ClientComponent />
      </div>
      <hr />
      <p>
      ...
      <div className={style.notUseComponent}>
        <ServerComponent />
      </div>
    </div>
  );
